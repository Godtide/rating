...
func main() {
	...
	r := &handlers.RewardHandler{UserRewardCol: userRewardCol, RewardCol: rewardCol}

	e.POST("/users", uh.CreateUser)
	e.POST("/admin/reward", r.CreateRewards)
	e.POST("/reward/create", ur.CreateUserRewards)
	e.POST("/reward/claim", ur.ClaimReward)
	e.GET("/rewards", r.GetRewards)
